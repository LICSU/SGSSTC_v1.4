<%@ Page Language="C#" MasterPageFile="~/source/MasterPages/Menu.Master" AutoEventWireup="true" CodeBehind="Create_EstructuraElectricos.aspx.cs" Inherits="SGSSTC.source.sistema.Hacer.Create_EstructuraElectricos" %>
    ...
    <div class="row">
		<div class="col-md-8 col-md-offset-2">
            <asp:Table runat="server" ID="tbFactores" CssClass="table table-response">
                ...
                <asp:TableRow>
                    <asp:TableCell>Cables en mal estado </asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Condiciones eléctricas inadecuadas </asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Toma corriente sin protección</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Fallas de aislación en las conexiones</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Instalaciones sin puesta a tierra</asp:TableCell>
