<%@ Page Language="C#" MasterPageFile="~/source/MasterPages/Menu.Master" AutoEventWireup="true" CodeBehind="Create_EstructuraPsicosociales.aspx.cs" Inherits="SGSSTC.source.sistema.Hacer.Create_EstructuraPsicosociales" %>
    ...
    <div class="row">
		<div class="col-md-8 col-md-offset-2">
            <asp:Table runat="server" ID="tbFactores" CssClass="table table-response">
                ...
                <asp:TableRow>
                    <asp:TableCell>Deficiencias en la Gestión Organizacional</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Deficiencias en la organización del trabajo </asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Diferencias entre el grupo de trabajo</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Condiciones inadecuadas de la tarea</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Altas Demandas físicas ( postura corporal)</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Condiciones de trabajo deficientes</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell> Ajuste entre la tarea y el conocimiento de la persona</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Jornadas Laborales extenuantes</asp:TableCell>
                 ...
                 <asp:TableRow>
                    <asp:TableCell>Accidente laboral traumático</asp:TableCell>
