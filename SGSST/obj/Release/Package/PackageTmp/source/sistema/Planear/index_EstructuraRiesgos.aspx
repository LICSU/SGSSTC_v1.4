<%@ Page Language="C#" MasterPageFile="~/source/MasterPages/Menu.Master" AutoEventWireup="true" CodeBehind="index_EstructuraRiesgos.aspx.cs" Inherits="SGSSTC.source.sistema.Hacer.index_EstructuraRiesgos" %>
    ...
    <asp:UpdatePanel ID="updatePanelPrinicpal" runat="server">
        ...
        <ContentTemplate>
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">Formato para la identificación de riesgos</a></li>
            </ol>

            <div class="page-header">
                <h1 class="text-center">Formato para la identificación de riesgos</h1>
            </div>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="modal-body form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <asp:Button ID="btnCrearInsExt" runat="server" Text="Información"
                                        class="btn btn-block btn-primary" CommandArgument='1'
                                        OnClick="AgregarRegistro"></asp:Button>
                                </div>
                                <div class="col-md-6">
                                    <asp:Button ID="Button3" runat="server" Text="Químicos"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <asp:Button ID="Button4" runat="server" Text="Físicos"
                                        class="btn btn-block btn-primary" CommandArgument='3'
                                        OnClick="AgregarRegistro"></asp:Button>
                                </div>
                                <div class="col-md-6">
                                    <asp:Button ID="Button5" runat="server" Text="Mecánicos"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <asp:Button ID="Button6" runat="server" Text="Biológicos"
                                        class="btn btn-block btn-primary" CommandArgument='5'
                                        OnClick="AgregarRegistro"></asp:Button>
                                </div>
                                <div class="col-md-6">
                                    <asp:Button ID="Button7" runat="server" Text="Disergonómicos"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <asp:Button ID="Button8" runat="server" Text="Psicosociales"
                                        class="btn btn-block btn-primary" CommandArgument='7'
                                        OnClick="AgregarRegistro"></asp:Button>
                                </div>
                                <div class="col-md-6">
                                    <asp:Button ID="Button9" runat="server" Text="Eléctricos"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <asp:Button ID="Button2" runat="server" Text="Locativos"
