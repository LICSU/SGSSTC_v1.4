<%@ Page Language="C#" MasterPageFile="~/source/MasterPages/Menu.Master" AutoEventWireup="true" CodeBehind="index_EvaluacionRiesgos.aspx.cs" Inherits="SGSSTC.source.sistema.Hacer.index_EvaluacionRiesgos" %>
    ...
    <asp:UpdatePanel ID="updatePanelPrinicpal" runat="server">
        ...
        <ContentTemplate>
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">Formato para el modelo de descripción de procesos de trabajo</a></li>
            </ol>

            <div class="page-header">
                <h1 class="text-center">Formato para modelo de procesos y matriz de valoración</h1>
            </div>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="modal-body form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <asp:Button ID="btnCrearInsExt" runat="server" Text="Modelo de Proceso"
                                        class="btn btn-block btn-primary" CommandArgument='1'
                                        OnClick="AgregarRegistro"></asp:Button>
                                </div>
                                <div class="col-md-6">
                                    <asp:Button ID="Button3" runat="server" Text="Matriz de Riesgos"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <asp:Button ID="Button4" runat="server" Text="Peligros"
                                        class="btn btn-block btn-primary" CommandArgument='3'
                                        OnClick="AgregarRegistro"></asp:Button>
                                </div>
                                <div class="col-md-6">
                                    <asp:Button ID="Button5" runat="server" Text="Nivel de Deficiencia"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <asp:Button ID="Button6" runat="server" Text="Nivel de Exposición"
                                        class="btn btn-block btn-primary" CommandArgument='5'
                                        OnClick="AgregarRegistro"></asp:Button>
                                </div>
                                <div class="col-md-6">
                                    <asp:Button ID="Button7" runat="server" Text="Nivel de Probabilidad"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <asp:Button ID="Button8" runat="server" Text="Nivel de Consecuencias"
                                        class="btn btn-block btn-primary" CommandArgument='7'
                                        OnClick="AgregarRegistro"></asp:Button>
                                </div>
                                <div class="col-md-6">
                                    <asp:Button ID="Button9" runat="server" Text="Nivel de Riesgos"
