<%@ Page Language="C#" MasterPageFile="~/source/MasterPages/Menu.Master" AutoEventWireup="true" CodeBehind="Create_EstructuraMecanicos.aspx.cs" Inherits="SGSSTC.source.sistema.Hacer.Create_EstructuraMecanicos" %>
    ...
    <div class="row">
		<div class="col-md-8 col-md-offset-2">
            <asp:Table runat="server" ID="tbFactores" CssClass="table table-response">
                ...
                <asp:TableRow>
                    <asp:TableCell>Contacto con material  cortopunzante o rugoso</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Golpeado contra</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Golpeado por </asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell> Proyección de chispas o partículas</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Proyección del objeto de trabajo</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Caídas al mismo o distinto nivel/ pisar sobre</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell> Caída de objetos</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Atrapamiento/ Aplastamiento</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Contacto con material cortante/ punzante </asp:TableCell>
