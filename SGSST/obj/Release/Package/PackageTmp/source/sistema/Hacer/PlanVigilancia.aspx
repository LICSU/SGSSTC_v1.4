<%@ Page Title="" Language="C#" MasterPageFile="~/source/MasterPages/Menu.Master" AutoEventWireup="true" CodeBehind="PlanVigilancia.aspx.cs" Inherits="SGSST.source.sistema.Hacer.PlanVigilancia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="#">Plan de Vigilancia Epidemiológica</a></li>
    </ol>
    
    <div class="page-header">
        <h1 class="text-center">Plan de Vigilancia Epidemiológica</h1>
    </div>
