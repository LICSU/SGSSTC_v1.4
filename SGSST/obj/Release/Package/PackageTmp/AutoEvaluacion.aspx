<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AutoEvaluacion.aspx.cs" Inherits="SGSST.AutoEvaluacion" %>
...
<head runat="server">
	...
	<webopt:BundleReference runat="server" Path="~/bundles/SGSSTCss" />

	<title>SGSST</title>
</head>

<body style="background-image:url(splash/images/img_4.jpg);">
	<form id="form1" runat="server">

		<div  style="width:98%;display:block;
	margin: 0 auto;">

			<div class="page-header" style="border-bottom: 1px;">
			...
			<asp:UpdatePanel ID="MyUpdatePanel" runat="server" UpdateMode="Always">
				...
				<ContentTemplate>
					...
					<div class="row text-center" style="background-color : ghostwhite ;">
