<%@ Page Language="C#" MasterPageFile="~/source/MasterPages/Menu.Master" AutoEventWireup="true" CodeBehind="index_ObjetivosSGSST.aspx.cs" Inherits="SGSSTC.source.sistema.Hacer.index_ObjetivosSGSST" %>
    ...
    <asp:UpdatePanel ID="updatePanelPrinicpal" runat="server">
        ...
        <ContentTemplate>
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">Objetivos SG-SST</a></li>
            </ol>

            <div class="page-header">
                <h1 class="text-center">Objetivos SG-SST</h1>
            </div>
            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-3">
                    <asp:TextBox ID="txtBuscar" data-toggle="tooltip" data-placement="bottom" title="Ingrese Texto a Buscar"
                        runat="server" class="form-control" PlaceHolder="Ingrese el objetivo a buscar"></asp:TextBox>
                </div>
            ...
            <div class="row text-center">
                <div class="col-md-4 col-md-offset-2">
                    <asp:ImageButton alt="-" ID="btnAgregar" runat="server" ImageUrl="~\ico\agregar.png"
                        PostBackUrl="~/source/sistema/Planear/create_ObjetivosSGSST.aspx" />
                    <h4>Crear Objetivos SG-SST</h4>
                </div>

                <div class="col-md-4">
                    <asp:ImageButton alt="-" ID="btnSubir" runat="server" ImageUrl="~\ico\upload.png"
                        data-toggle="modal" data-target="#EscaneadoModal" />
                    <h4>Subir Objetivos SG-SST</h4>
                </div>
            </div>
