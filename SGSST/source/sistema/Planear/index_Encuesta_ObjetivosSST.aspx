<%@ Page Language="C#" MasterPageFile="~/source/MasterPages/Menu.Master" AutoEventWireup="true" CodeBehind="index_Encuesta_ObjetivosSST.aspx.cs" Inherits="SGSSTC.source.sistema.Hacer.index_Encuesta_ObjetivosSST" %>
    ...
    <asp:UpdatePanel ID="updatePanelPrinicpal" runat="server">
        <ContentTemplate>
            ...
            <div class="page-header">
                <h1 class="text-center">Encuesta sobre objetivos de la politica de SST</h1>
            </div>
