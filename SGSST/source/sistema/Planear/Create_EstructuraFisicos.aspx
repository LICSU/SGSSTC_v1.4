<%@ Page Language="C#" MasterPageFile="~/source/MasterPages/Menu.Master" AutoEventWireup="true" CodeBehind="Create_EstructuraFisicos.aspx.cs" Inherits="SGSSTC.source.sistema.Hacer.Create_EstructuraFisicos" %>
    ...
    <div class="row">
		<div class="col-md-8 col-md-offset-2">
            <asp:Table runat="server" ID="tbFactores" CssClass="table table-response">
                ...
                <asp:TableRow>
                    <asp:TableCell>Ruido</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Radiaciones ionizantes</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Radiaciones Ópticas </asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Radiaciones térmicas</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Temperatura Extrema</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Vibraciones</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Iluminación</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Humedad</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Presión </asp:TableCell>
