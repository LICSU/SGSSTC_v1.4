<%@ Page Language="C#" MasterPageFile="~/source/MasterPages/Menu.Master" AutoEventWireup="true" CodeBehind="Create_EstructuraLocativos.aspx.cs" Inherits="SGSSTC.source.sistema.Hacer.Create_EstructuraLocativos" %>
    ...
    <div class="row">
		<div class="col-md-8 col-md-offset-2">
            <asp:Table runat="server" ID="tbFactores" CssClass="table table-response">
                ...
                <asp:TableRow>
                    <asp:TableCell>Mala disposición del espacio</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Desorden en el área</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Condiciones insalubres</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Ausencia de Señalización</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Irregularidades en el piso </asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Filtraciones en el techo </asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Mal estado de la máquina</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Paredes inestables</asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>Mal estado de las guardas de la máquina </asp:TableCell>
