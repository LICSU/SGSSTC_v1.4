<%@ Page Language="C#" MasterPageFile="~/source/MasterPages/Menu.Master" AutoEventWireup="true" CodeBehind="Create_EvaluacionExposicion.aspx.cs" Inherits="SGSST.source.sistema.Planear.Create_EvaluacionExposicion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
	...
	<div class="page-header">
		<h1 class="text-center">Formato para el Nivel de Exposición</h1>
	</div>
    ...
    <div class="row">
		<div class="col-md-8 col-md-offset-2">
             <CKEditor:CKEditorControl ID="txtExposicion" BasePath="/ckeditor/" runat="server">
                 <table border="1">
					<thead>
						<tr>
							<th colspan="3" style="background-color:#538DD5; color:#000000; text-align:center;">TABLA III. DETERMINACIÓN DEL NIVEL DE EXPOSICIÓN</th>
						</tr>
						<tr>
							<th style="background-color:#538DD5; color:#000000; text-align:center;">Nivel de exposición</th>
							<th style="background-color:#538DD5; color:#000000; text-align:center;">Valor de NE</th>
